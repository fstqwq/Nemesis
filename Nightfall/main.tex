...
\begin{document}
	...
	\begin{multicols}{2}
		...
		\begin{spacing}{0.6}
			...
			\section{Geometry}
				\subsection{二维几何基础操作}
				\inputminted{cpp}{src/Geometry/计算几何.cpp}
				\subsection{直线半平面交}
			...
			\section{Data Structure}
				...
				\subsection{动态斜率优化}
				\inputminted{cpp}{src/DataStructure/动态斜率优化.cpp}
			...
			\section{Math 数学}
				...
				\subsection{Miller Rabin And Pollard Rho 启发式分解}
				\inputminted{cpp}{src/Math/Miller Rabin And Pollard Rho.cpp}
				\subsection{杜教筛}
				\inputminted{cpp}{src/Math/杜教筛.cpp}
				\subsection{Extended Eratosthenes Sieve 扩展挨氏筛}
			...
			\section{Miscellany}
				...
				\subsection{Vimrc}
				\inputminted{text}{src/Miscellany/vimrc}
				\subsection{读入优化相关}
