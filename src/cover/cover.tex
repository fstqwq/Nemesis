...
\setCJKfamilyfont{pixel}{Fusion Pixel 12px Proportional zh_hans}[Scale=0.8]
...
\begin{figure*}[h]
    \centering
    \includegraphics[width=200pt]{cover/sjtubannerred.pdf}
\end{figure*}
...
\end{center}
\vspace*{1cm}
\centerline{\large Last Commit: \input{|"python cover/info.py"}}
\newpage