...
int a[maxn],n,dfn[maxn],pos[maxn],timer,inv[maxn];
int fa[maxn],size[maxn],dep[maxn],son[maxn],
  top[maxn], st[maxn], vis[maxn];
void dfs1(int x); // 树剖
void dfs2(int x);
