...
struct Maxclique {
  ...
  typedef vector <Vertex> Vertices; Vertices V;
  typedef vector<int> ColorClass; ColorClass QMAX,Q;
  vector <ColorClass> C;
  static bool desc_degree(const Vertex &vi,
                          const Vertex &vj){
    return vi.d>vj.d; }
  ...
  Maxclique(const BB *conn,const int sz,
          const float tt = .025)
