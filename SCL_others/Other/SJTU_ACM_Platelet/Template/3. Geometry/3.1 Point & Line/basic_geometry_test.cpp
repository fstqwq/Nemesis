...
#include <cstdio>
int main() {
    point res = intersect(line(point(-1, -1), point(1, 1)), line(point(-0.5, 1.7), point(0.5, -1.7)));
    printf("%Lf %Lf\n", res.x, res.y);
    res = projection(point(1, 1), line(point(-1, 1), point(1, -1)));
    printf("%Lf %Lf\n", res.x, res.y);
    printf("%Lf\n", dis(point(1, 1), line(point(-1, 1), point(1, -1))));
    point p1, p2;
    intersect(line(point(-1, -1), point(1, 1)), circle(point(0, 0), 1), p1, p2);
    printf("%Lf %Lf    %Lf %Lf\n", p1.x, p1.y, p2.x, p2.y);
    intersect(circle(point(-1, 0), 2), circle(point(1, 0), 2), p1, p2);
    printf("%Lf %Lf    %Lf %Lf\n", p1.x, p1.y, p2.x, p2.y);
    intersect(circle(point(-1, 0), 1), circle(point(1, 0), 1), p1, p2);
    printf("%Lf %Lf    %Lf %Lf\n", p1.x, p1.y, p2.x, p2.y);
    tangent(point(2, 0), circle(point(0, 0), 1), p1, p2);
    printf("%Lf %Lf    %Lf %Lf\n", p1.x, p1.y, p2.x, p2.y);
    line l1, l2;
    ex_tangent(circle(point(0, 0), 1), circle(point(1, 1), 1), l1, l2);
    printf("%Lf %Lf    %Lf %Lf\n", l1.a.x, l1.a.y, l1.b.x, l1.b.y);
    printf("%Lf %Lf    %Lf %Lf\n", l2.a.x, l2.a.y, l2.b.x, l2.b.y);
    ex_tangent(circle(point(1, 1), 1), circle(point(2, 2), 2), l1, l2);
    printf("%Lf %Lf    %Lf %Lf\n", l1.a.x, l1.a.y, l1.b.x, l1.b.y);
    printf("%Lf %Lf    %Lf %Lf\n", l2.a.x, l2.a.y, l2.b.x, l2.b.y);
    ex_tangent(circle(point(0, 1), 1), circle(point(0, 2), 2), l1, l2);
    printf("%Lf %Lf    %Lf %Lf\n", l1.a.x, l1.a.y, l1.b.x, l1.b.y);
    printf("%Lf %Lf    %Lf %Lf\n", l2.a.x, l2.a.y, l2.b.x, l2.b.y);
    in_tangent(circle(point(-1, -1), 1), circle(point(1, 1), 1), l1, l2);
    printf("%Lf %Lf    %Lf %Lf\n", l1.a.x, l1.a.y, l1.b.x, l1.b.y);
    printf("%Lf %Lf    %Lf %Lf\n", l2.a.x, l2.a.y, l2.b.x, l2.b.y);
    in_tangent(circle(point(1, 0), 1), circle(point(-1, 0), 1), l1, l2);
    printf("%Lf %Lf    %Lf %Lf\n", l1.a.x, l1.a.y, l1.b.x, l1.b.y);
    printf("%Lf %Lf    %Lf %Lf\n", l2.a.x, l2.a.y, l2.b.x, l2.b.y);
    return 0;
}
